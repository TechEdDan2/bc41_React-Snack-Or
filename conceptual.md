...
Inside of the a <Routes> component you could define a route like this: <Route path="*" element={<h2>404: Page Not Found</h2>} /> . It should be the last route defined so it catches all unmateched routes. Another way is to create a dedicated NotFound component and use it in the same way: <Route path="*" element={<NotFound />} /> .
